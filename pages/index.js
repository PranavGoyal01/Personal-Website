...
const projects = [{ title: "AI-Cars-in-Real-Cities", repo: "https://github.com/PranavGoyal01/AI-Cars-in-Real-Cities", blurb: "Simulation where AI cars navigate real cities using OpenStreetMap data and Dijkstra pathing." }];
